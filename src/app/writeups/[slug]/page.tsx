...
import { ArrowLeft, Monitor, Calendar, Award } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-3">
              ...
              {/* Prev / Next Pagination Actions */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-t border-border pt-8 gap-4">
                {prevWriteup ? (
                  <Link
                    href={`/writeups/${prevWriteup.slug}`}
                    className="flex flex-col p-4 rounded-xl border border-border bg-card hover:border-accent/40 hover:shadow-glow theme-transition sm:max-w-[48%] group"
                    id="prev-writeup-link"
                  >
                    <span className="text-[10px] font-mono text-muted-foreground uppercase mb-1">
                      Previous machine
                    </span>
                    <span className="text-sm font-bold font-mono text-foreground group-hover:text-accent theme-transition truncate">
                      ← {prevWriteup.title}
                    </span>
                  </Link>
                ) : (
                ...
                {nextWriteup ? (
                  <Link
                    ...
                    className="flex flex-col p-4 rounded-xl border border-border bg-card hover:border-accent/40 hover:shadow-glow theme-transition sm:max-w-[48%] items-end text-right group"
                    id="next-writeup-link"
                  >
                    <span className="text-[10px] font-mono text-muted-foreground uppercase mb-1">
                      Next machine
                    </span>
